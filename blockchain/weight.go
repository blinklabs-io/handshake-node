...
func GetBlockWeight(blk *hnsutil.Block) int64 {
...
func GetTransactionWeight(tx *hnsutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *hnsutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
