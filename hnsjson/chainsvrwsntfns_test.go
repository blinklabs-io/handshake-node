...
func TestChainSvrWsNtfns(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			unmarshalled: &hnsjson.BlockConnectedNtfn{
				Hash:   "123",
				Height: 100000,
				Time:   123456789,
			},
		},
		{
			...
			unmarshalled: &hnsjson.BlockDisconnectedNtfn{
				Hash:   "123",
				Height: 100000,
				Time:   123456789,
			},
		},
		{
			...
			unmarshalled: &hnsjson.FilteredBlockConnectedNtfn{
				Height:        100000,
				Header:        "header",
		...
		},
		{
			...
			unmarshalled: &hnsjson.FilteredBlockDisconnectedNtfn{
				Height: 100000,
				Header: "header",
			},
		},
		...
		},
		{
			...
			unmarshalled: &hnsjson.RescanFinishedNtfn{
				Hash:   "123",
				Height: 100000,
				Time:   12345678,
			},
		},
		{
			...
			unmarshalled: &hnsjson.RescanProgressNtfn{
				Hash:   "123",
				Height: 100000,
				Time:   12345678,
			},
		},
		{
			...
			unmarshalled: &hnsjson.TxAcceptedNtfn{
				TxID:   "123",
				Amount: 1.5,
			},
		},
		{
			...
			staticNtfn: func() interface{} {
				...
				return hnsjson.NewTxAcceptedVerboseNtfn(txResult)
			},
			...
			unmarshalled: &hnsjson.TxAcceptedVerboseNtfn{
				RawTx: hnsjson.TxRawResult{
					Hex:           "001122",
					Txid:          "123",
					Version:       1,
					LockTime:      4294967295,
		...
		},
		{
			...
			unmarshalled: &hnsjson.RelevantTxAcceptedNtfn{
				Transaction: "001122",
			},
		},
	}
	...
	for i, test := range tests {
		...
		marshalled, err := hnsjson.MarshalCmd(hnsjson.RpcVersion1, nil, test.staticNtfn())
		if err != nil {
		...
		// notifications.
		marshalled, err = hnsjson.MarshalCmd(hnsjson.RpcVersion1, nil, cmd)
		if err != nil {
			t.Errorf("MarshalCmd #%d (%s) unexpected error: %v", i,
				test.name, err)
			continue
