...
func TestBtcWalletExtCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			unmarshalled: &hnsjson.CreateNewAccountCmd{
				Account: "acct",
			},
		},
		{
			...
			unmarshalled: &hnsjson.DumpWalletCmd{
				Filename: "filename",
			},
		},
		{
			...
			unmarshalled: &hnsjson.ImportAddressCmd{
				Address: "1Address",
		...
		},
		{
			...
			unmarshalled: &hnsjson.ImportPubKeyCmd{
				PubKey: "031234",
				Rescan: hnsjson.Bool(true),
			},
		},
		...
		},
		{
			...
			unmarshalled: &hnsjson.ImportWalletCmd{
				Filename: "filename",
			},
		},
		{
			...
			unmarshalled: &hnsjson.RenameAccountCmd{
				OldAccount: "oldacct",
				NewAccount: "newacct",
			},
		},
