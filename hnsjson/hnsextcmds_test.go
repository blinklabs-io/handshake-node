...
// TestHnsExtCmds tests all of the handshake-node extended commands marshal and unmarshal
// into valid results include handling of optional fields being omitted in the
// marshalled command, while optional fields with defaults have the default
// assigned on unmarshalled commands.
func TestHnsExtCmds(t *testing.T) {
	t.Parallel()
	...
	tests := []struct {
	...
	}{
		{
			...
			unmarshalled: &hnsjson.DebugLevelCmd{
				LevelSpec: "trace",
			},
		},
		{
			...
			unmarshalled: &hnsjson.NodeCmd{
				SubCmd: hnsjson.NRemove,
				Target: "1.1.1.1",
			},
		},
		{
		...
		},
		{
			...
			unmarshalled: &hnsjson.NodeCmd{
				SubCmd:        hnsjson.NConnect,
				Target:        "1.1.1.1",
				ConnectSubCmd: hnsjson.String("perm"),
			},
		},
		{
			name: "node",
			...
			unmarshalled: &hnsjson.NodeCmd{
				SubCmd:        hnsjson.NConnect,
				Target:        "1.1.1.1",
				ConnectSubCmd: hnsjson.String("temp"),
			},
		},
		{
			name: "generate",
			...
			unmarshalled: &hnsjson.GenerateCmd{
				NumBlocks: 1,
			},
		},
		{
			...
			unmarshalled: &hnsjson.GenerateToAddressCmd{
				NumBlocks: 1,
				Address:   "1Address",
				MaxTries: func() *int64 {
					var i int64 = 1000000
		...
		},
		{
			...
			unmarshalled: &hnsjson.GetBestBlockCmd{},
		},
		{
			name: "getcurrentnet",
			newCmd: func() (interface{}, error) {
			...
			unmarshalled: &hnsjson.GetCurrentNetCmd{},
		},
		{
			name: "getheaders",
			newCmd: func() (interface{}, error) {
			...
			unmarshalled: &hnsjson.GetHeadersCmd{
		...
		},
		{
			...
			unmarshalled: &hnsjson.VersionCmd{},
		},
	}
