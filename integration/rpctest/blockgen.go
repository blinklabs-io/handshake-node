...
func CreateBlock(prevBlock *hnsutil.Block, inclusionTxs []*hnsutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr hnsutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*hnsutil.Block, error) {
	...
	blockTxns := []*hnsutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := hnsutil.NewBlock(&block)
