...
func parseArgs(funcName string, args ...any) (string, wire.BitcoinNet, error) {
	if len(args) != 2 {
...
func openDBDriver(args ...any) (database.DB, error) {
...
func createDBDriver(args ...any) (database.DB, error) {
