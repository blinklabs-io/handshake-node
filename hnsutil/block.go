...
// Tx returns a wrapped transaction (hnsutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (hnsutil.Tx) for all
...
// instead provides easy access to wrapped versions (hnsutil.Tx) of them.
...
func NewBlockFromBytes(serializedBlock []byte) (*Block, error) {
	...
	// This initializes []hnsutil.Tx to have the serialized raw
