...
func TestBlock(t *testing.T) {
	b := hnsutil.NewBlock(&Block100000)
	...
	wantHashStr := "0cf544cc6cd2896765993f7aa0240471dd53f267d1d473f429dfc6fed6463e47"
	...
	wantTxHashes := []string{
		"0c81f8f45e36f7688992f10fdca114c06f0dab3353ae3576be77290684170081",
		"9ccf7b4383f3c0e66973f3a8fcfc2d11ec62169c011950547e6f033d15fbf149",
		"1fb3b8ae49bc3b574a4de3af93592ed20a797f9b29c590f6caa8f45160f29409",
		"43de94f366f2a0aeb136fd5ad37ab7414e41e18569ba9d647097ca2d2ced7041",
	}
	...
	wantTxLocs := []wire.TxLoc{
		...
		{TxStart: 335, TxLen: 256},
		{TxStart: 591, TxLen: 254},
		{TxStart: 845, TxLen: 224},
	}
...
func TestNewBlockFromBytes(t *testing.T) {
	...
	b, err := hnsutil.NewBlockFromBytes(block100000Bytes)
	if err != nil {
...
func TestNewBlockFromBlockAndBytes(t *testing.T) {
	...
	// Create a new block from the serialized bytes.
	b := hnsutil.NewBlockFromBlockAndBytes(&Block100000, block100000Bytes)
...
func TestBlockErrors(t *testing.T) {
	...
	testErr := hnsutil.OutOfRangeError(wantErr)
	...
	_, err = b.TxHash(-1)
	if _, ok := err.(hnsutil.OutOfRangeError); !ok {
		t.Errorf("TxHash: wrong error - got: %v <%T>, "+
			"want: <%T>", err, err, hnsutil.OutOfRangeError(""))
	}
			...
			TxOut: []*wire.TxOut{
				{
					...
					Address: wire.Address{
						Version: 0,
						Hash: []byte{
							// HASH160 of the original coinbase pubkey
