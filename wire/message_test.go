...
func TestMessage(t *testing.T) {
	...
	bh := NewBlockHeader(1, &chainhash.Hash{}, &chainhash.Hash{}, &chainhash.Hash{}, &chainhash.Hash{}, 0, 0)
	...
	tests := []struct {
		...
		{msgVersion, msgVersion, pver, MainNet, 132},
		...
		{msgMerkleBlock, msgMerkleBlock, pver, MainNet, 266},
...
func TestReadMessageWireErrors(t *testing.T) {
	...
	// Wire encoded bytes for main and regtest networks magic identifiers.
