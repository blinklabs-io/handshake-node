...
func (r FutureGetTransactionResult) Receive() (*hnsjson.GetTransactionResult, error) {
	...
	var getTx hnsjson.GetTransactionResult
...
func (c *Client) GetTransactionAsync(txHash *chainhash.Hash) FutureGetTransactionResult {
	...
	cmd := hnsjson.NewGetTransactionCmd(hash, nil)
...
func (c *Client) GetTransaction(txHash *chainhash.Hash) (*hnsjson.GetTransactionResult, error) {
...
func (c *Client) GetTransactionWatchOnlyAsync(txHash *chainhash.Hash, watchOnly bool) FutureGetTransactionResult {
	...
	cmd := hnsjson.NewGetTransactionCmd(hash, &watchOnly)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetTransactionWatchOnly(txHash *chainhash.Hash, watchOnly bool) (*hnsjson.GetTransactionResult, error) {
...
func (r FutureListTransactionsResult) Receive() ([]hnsjson.ListTransactionsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var transactions []hnsjson.ListTransactionsResult
...
func (c *Client) ListTransactionsAsync(account string) FutureListTransactionsResult {
	cmd := hnsjson.NewListTransactionsCmd(&account, nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListTransactions(account string) ([]hnsjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountAsync(account string, count int) FutureListTransactionsResult {
	cmd := hnsjson.NewListTransactionsCmd(&account, &count, nil, nil)
	return c.SendCmd(cmd)
}
...
// different options.
func (c *Client) ListTransactionsCount(account string, count int) ([]hnsjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromAsync(account string, count, from int) FutureListTransactionsResult {
	cmd := hnsjson.NewListTransactionsCmd(&account, &count, &from, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListTransactionsCountFrom(account string, count, from int) ([]hnsjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromWatchOnlyAsync(account string, count, from int, watchOnly bool) FutureListTransactionsResult {
	cmd := hnsjson.NewListTransactionsCmd(&account, &count, &from, &watchOnly)
	return c.SendCmd(cmd)
}
...
//
// See the ListTransactions and ListTransactionsCount functions to use defaults.
func (c *Client) ListTransactionsCountFromWatchOnly(account string, count, from int, watchOnly bool) ([]hnsjson.ListTransactionsResult, error) {
...
func (r FutureListUnspentResult) Receive() ([]hnsjson.ListUnspentResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var unspent []hnsjson.ListUnspentResult
...
func (c *Client) ListUnspentAsync() FutureListUnspentResult {
	cmd := hnsjson.NewListUnspentCmd(nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListUnspentMinAsync(minConf int) FutureListUnspentResult {
	cmd := hnsjson.NewListUnspentCmd(&minConf, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAsync(minConf, maxConf int) FutureListUnspentResult {
	cmd := hnsjson.NewListUnspentCmd(&minConf, &maxConf, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []hnsutil.Address) FutureListUnspentResult {
	addrStrs := make([]string, 0, len(addrs))
	for _, a := range addrs {
		addrStrs = append(addrStrs, a.EncodeAddress())
	}

	cmd := hnsjson.NewListUnspentCmd(&minConf, &maxConf, &addrStrs)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListUnspent() ([]hnsjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMin(minConf int) ([]hnsjson.ListUnspentResult, error) {
...
// a filter.
func (c *Client) ListUnspentMinMax(minConf, maxConf int) ([]hnsjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []hnsutil.Address) ([]hnsjson.ListUnspentResult, error) {
...
func (r FutureListSinceBlockResult) Receive() (*hnsjson.ListSinceBlockResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var listResult hnsjson.ListSinceBlockResult
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	var hash *string
	if blockHash != nil {
		hash = hnsjson.String(blockHash.String())
	}

	cmd := hnsjson.NewListSinceBlockCmd(hash, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListSinceBlock(blockHash *chainhash.Hash) (*hnsjson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfAsync(blockHash *chainhash.Hash, minConfirms int) FutureListSinceBlockResult {
	...
	cmd := hnsjson.NewListSinceBlockCmd(hash, &minConfirms, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConf(blockHash *chainhash.Hash, minConfirms int) (*hnsjson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfWatchOnlyAsync(blockHash *chainhash.Hash, minConfirms int, watchOnly bool) FutureListSinceBlockResult {
	...
	cmd := hnsjson.NewListSinceBlockCmd(hash, &minConfirms, &watchOnly)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConfWatchOnly(blockHash *chainhash.Hash, minConfirms int, watchOnly bool) (*hnsjson.ListSinceBlockResult, error) {
...
func (c *Client) LockUnspentAsync(unlock bool, ops []*wire.OutPoint) FutureLockUnspentResult {
	outputs := make([]hnsjson.TransactionInput, len(ops))
	for i, op := range ops {
		outputs[i] = hnsjson.TransactionInput{
			Txid: op.Hash.String(),
			Vout: op.Index,
		}
	}
	cmd := hnsjson.NewLockUnspentCmd(unlock, outputs)
	return c.SendCmd(cmd)
}
...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	var inputs []hnsjson.TransactionInput
...
func (c *Client) ListLockUnspentAsync() FutureListLockUnspentResult {
	cmd := hnsjson.NewListLockUnspentCmd()
	return c.SendCmd(cmd)
}
...
func (c *Client) SetTxFee(fee hnsutil.Amount) error {
...
func (c *Client) SendToAddress(address hnsutil.Address, amount hnsutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address hnsutil.Address,
	amount hnsutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address hnsutil.Address, amount hnsutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress hnsutil.Address, amount hnsutil.Amount) (*chainhash.Hash, error) {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress hnsutil.Address, amount hnsutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress hnsutil.Address, amount hnsutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress hnsutil.Address,
	amount hnsutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[hnsutil.Address]hnsutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[hnsutil.Address]hnsutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[hnsutil.Address]hnsutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (hnsutil.Address, error) {
	...
	return hnsutil.DecodeAddress(addr, r.network)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []hnsutil.Address, account string) FutureAddMultisigAddressResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := hnsjson.NewAddMultisigAddressCmd(requiredSigs, addrs, &account)
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []hnsutil.Address, account string) (hnsutil.Address, error) {
...
func (r FutureCreateMultisigResult) Receive() (*hnsjson.CreateMultiSigResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var multisigRes hnsjson.CreateMultiSigResult
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []hnsutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := hnsjson.NewCreateMultisigCmd(requiredSigs, addrs)
	return c.SendCmd(cmd)
}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []hnsutil.Address) (*hnsjson.CreateMultiSigResult, error) {
...
func (c *Client) CreateNewAccountAsync(account string) FutureCreateNewAccountResult {
	cmd := hnsjson.NewCreateNewAccountCmd(account)
	return c.SendCmd(cmd)
}
...
func (r FutureCreateWalletResult) Receive() (*hnsjson.CreateWalletResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var createWalletResult hnsjson.CreateWalletResult
...
// method.
type CreateWalletOpt func(*hnsjson.CreateWalletCmd)
...
func WithCreateWalletDisablePrivateKeys() CreateWalletOpt {
	return func(c *hnsjson.CreateWalletCmd) {
		c.DisablePrivateKeys = hnsjson.Bool(true)
	}
}
...
func WithCreateWalletPassphrase(value string) CreateWalletOpt {
	return func(c *hnsjson.CreateWalletCmd) {
		c.Passphrase = hnsjson.String(value)
	}
}
...
func WithCreateWalletAvoidReuse() CreateWalletOpt {
	return func(c *hnsjson.CreateWalletCmd) {
		c.AvoidReuse = hnsjson.Bool(true)
	}
}
...
func (c *Client) CreateWalletAsync(name string, opts ...CreateWalletOpt) FutureCreateWalletResult {
	cmd := hnsjson.NewCreateWalletCmd(name, nil, nil, nil, nil)
...
func (c *Client) CreateWallet(name string, opts ...CreateWalletOpt) (*hnsjson.CreateWalletResult, error) {
...
func (r FutureGetAddressInfoResult) Receive() (*hnsjson.GetAddressInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var getAddressInfoResult hnsjson.GetAddressInfoResult
...
func (c *Client) GetAddressInfoAsync(address string) FutureGetAddressInfoResult {
	cmd := hnsjson.NewGetAddressInfoCmd(address)
	return c.SendCmd(cmd)
}

// GetAddressInfo returns information about the given bitcoin address.
func (c *Client) GetAddressInfo(address string) (*hnsjson.GetAddressInfoResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (hnsutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddressAsync(account string) FutureGetNewAddressResult {
	cmd := hnsjson.NewGetNewAddressCmd(&account, nil)
...
// chain params.
func (c *Client) GetNewAddress(account string) (hnsutil.Address, error) {
...
func (c *Client) GetNewAddressTypeAsync(account, addrType string) FutureGetNewAddressResult {
	cmd := hnsjson.NewGetNewAddressCmd(&account, &addrType)
	result := FutureGetNewAddressResult{
		network:         c.chainParams,
		responseChannel: c.SendCmd(cmd),
	}
...
// chain params.
func (c *Client) GetNewAddressType(account, addrType string) (hnsutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (hnsutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddressAsync(account string) FutureGetRawChangeAddressResult {
	cmd := hnsjson.NewGetRawChangeAddressCmd(&account, nil)
...
func (c *Client) GetRawChangeAddress(account string) (hnsutil.Address, error) {
...
func (c *Client) GetRawChangeAddressTypeAsync(account, addrType string) FutureGetRawChangeAddressResult {
	cmd := hnsjson.NewGetRawChangeAddressCmd(&account, &addrType)
	result := FutureGetRawChangeAddressResult{
		network:         c.chainParams,
		responseChannel: c.SendCmd(cmd),
	}
...
// transactions and NOT for normal use.
func (c *Client) GetRawChangeAddressType(account, addrType string) (hnsutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (hnsutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddressAsync(address string) FutureAddWitnessAddressResult {
	cmd := hnsjson.NewAddWitnessAddressCmd(address)
...
func (c *Client) AddWitnessAddress(address string) (hnsutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (hnsutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddressAsync(account string) FutureGetAccountAddressResult {
	cmd := hnsjson.NewGetAccountAddressCmd(account)
...
func (c *Client) GetAccountAddress(account string) (hnsutil.Address, error) {
...
func (c *Client) GetAccountAsync(address hnsutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
	cmd := hnsjson.NewGetAccountCmd(addr)
	return c.SendCmd(cmd)
}

// GetAccount returns the account associated with the passed address.
func (c *Client) GetAccount(address hnsutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address hnsutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
	cmd := hnsjson.NewSetAccountCmd(addr, account)
	return c.SendCmd(cmd)
}

// SetAccount sets the account associated with the passed address.
func (c *Client) SetAccount(address hnsutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]hnsutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
	...
	addresses := make([]hnsutil.Address, len(addrStrings))
	for i, addrString := range addrStrings {
		addresses[i], err = hnsutil.DecodeAddress(addrString, r.network)
		if err != nil {
			return nil, err
		}
	}
...
func (c *Client) GetAddressesByAccountAsync(account string) FutureGetAddressesByAccountResult {
	cmd := hnsjson.NewGetAddressesByAccountCmd(account)
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]hnsutil.Address, error) {
...
func (c *Client) Move(fromAccount, toAccount string, amount hnsutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount hnsutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount hnsutil.Amount,
...
func (c *Client) RenameAccountAsync(oldAccount, newAccount string) FutureRenameAccountResult {
	cmd := hnsjson.NewRenameAccountCmd(oldAccount, newAccount)
	return c.SendCmd(cmd)
}
...
// about the given bitcoin address.
func (r FutureValidateAddressResult) Receive() (*hnsjson.ValidateAddressWalletResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var addrResult hnsjson.ValidateAddressWalletResult
...
func (c *Client) ValidateAddressAsync(address hnsutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
	cmd := hnsjson.NewValidateAddressCmd(addr)
	return c.SendCmd(cmd)
}

// ValidateAddress returns information about the given bitcoin address.
func (c *Client) ValidateAddress(address hnsutil.Address) (*hnsjson.ValidateAddressWalletResult, error) {
...
func (c *Client) KeyPoolRefillAsync() FutureKeyPoolRefillResult {
	cmd := hnsjson.NewKeyPoolRefillCmd(nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) KeyPoolRefillSizeAsync(newSize uint) FutureKeyPoolRefillResult {
	cmd := hnsjson.NewKeyPoolRefillCmd(&newSize)
	return c.SendCmd(cmd)
}
...
func (r FutureListAccountsResult) Receive() (map[string]hnsutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]hnsutil.Amount)
	for k, v := range accounts {
		amount, err := hnsutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccountsAsync() FutureListAccountsResult {
	cmd := hnsjson.NewListAccountsCmd(nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListAccounts() (map[string]hnsutil.Amount, error) {
...
func (c *Client) ListAccountsMinConfAsync(minConfirms int) FutureListAccountsResult {
	cmd := hnsjson.NewListAccountsCmd(&minConfirms)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]hnsutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (hnsutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := hnsutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the Response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (hnsutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalanceAsync(account string) FutureGetBalanceResult {
	cmd := hnsjson.NewGetBalanceCmd(&account, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBalance(account string) (hnsutil.Amount, error) {
...
func (c *Client) GetBalanceMinConfAsync(account string, minConfirms int) FutureGetBalanceResult {
	cmd := hnsjson.NewGetBalanceCmd(&account, &minConfirms)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (hnsutil.Amount, error) {
...
func (r FutureGetBalancesResult) Receive() (*hnsjson.GetBalancesResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a floating point number.
	var balances hnsjson.GetBalancesResult
...
func (c *Client) GetBalancesAsync() FutureGetBalancesResult {
	cmd := hnsjson.NewGetBalancesCmd()
	return c.SendCmd(cmd)
}

// GetBalances returns the available balances from the server.
func (c *Client) GetBalances() (*hnsjson.GetBalancesResult, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (hnsutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAccountAsync(account string) FutureGetReceivedByAccountResult {
	cmd := hnsjson.NewGetReceivedByAccountCmd(account, nil)
	return c.SendCmd(cmd)
}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (hnsutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConfAsync(account string, minConfirms int) FutureGetReceivedByAccountResult {
	cmd := hnsjson.NewGetReceivedByAccountCmd(account, &minConfirms)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (hnsutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (hnsutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalanceAsync(account string) FutureGetUnconfirmedBalanceResult {
	cmd := hnsjson.NewGetUnconfirmedBalanceCmd(&account)
	return c.SendCmd(cmd)
}

// GetUnconfirmedBalance returns the unconfirmed balance from the server for
// the specified account.
func (c *Client) GetUnconfirmedBalance(account string) (hnsutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (hnsutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address hnsutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := hnsjson.NewGetReceivedByAddressCmd(addr, nil)
	return c.SendCmd(cmd)
...
// confirmations.
func (c *Client) GetReceivedByAddress(address hnsutil.Address) (hnsutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address hnsutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := hnsjson.NewGetReceivedByAddressCmd(addr, &minConfirms)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetReceivedByAddressMinConf(address hnsutil.Address, minConfirms int) (hnsutil.Amount, error) {
...
// Receive waits for the Response promised by the future and returns a list of
// balances by account.
func (r FutureListReceivedByAccountResult) Receive() ([]hnsjson.ListReceivedByAccountResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []hnsjson.ListReceivedByAccountResult
...
func (c *Client) ListReceivedByAccountAsync() FutureListReceivedByAccountResult {
	cmd := hnsjson.NewListReceivedByAccountCmd(nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccount() ([]hnsjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountMinConfAsync(minConfirms int) FutureListReceivedByAccountResult {
	cmd := hnsjson.NewListReceivedByAccountCmd(&minConfirms, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountMinConf(minConfirms int) ([]hnsjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAccountResult {
	cmd := hnsjson.NewListReceivedByAccountCmd(&minConfirms, &includeEmpty,
		nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountIncludeEmpty(minConfirms int, includeEmpty bool) ([]hnsjson.ListReceivedByAccountResult, error) {
...
// Receive waits for the Response promised by the future and returns a list of
// balances by address.
func (r FutureListReceivedByAddressResult) Receive() ([]hnsjson.ListReceivedByAddressResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []hnsjson.ListReceivedByAddressResult
	err = json.Unmarshal(res, &received)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListReceivedByAddressAsync() FutureListReceivedByAddressResult {
	cmd := hnsjson.NewListReceivedByAddressCmd(nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddress() ([]hnsjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressMinConfAsync(minConfirms int) FutureListReceivedByAddressResult {
	cmd := hnsjson.NewListReceivedByAddressCmd(&minConfirms, nil, nil)
	return c.SendCmd(cmd)
}
...
// received any payments in the results.
func (c *Client) ListReceivedByAddressMinConf(minConfirms int) ([]hnsjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAddressResult {
	cmd := hnsjson.NewListReceivedByAddressCmd(&minConfirms, &includeEmpty,
		nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressIncludeEmpty(minConfirms int, includeEmpty bool) ([]hnsjson.ListReceivedByAddressResult, error) {
...
func (c *Client) WalletPassphrase(passphrase string, timeoutSecs int64) error {
	cmd := hnsjson.NewWalletPassphraseCmd(passphrase, timeoutSecs)
...
func (c *Client) WalletPassphraseChangeAsync(old, new string) FutureWalletPassphraseChangeResult {
	cmd := hnsjson.NewWalletPassphraseChangeCmd(old, new)
	return c.SendCmd(cmd)
}
...
func (c *Client) SignMessageAsync(address hnsutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
	cmd := hnsjson.NewSignMessageCmd(addr, message)
	return c.SendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address hnsutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address hnsutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
	cmd := hnsjson.NewVerifyMessageCmd(addr, signature, message)
	return c.SendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address hnsutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*hnsutil.WIF, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return hnsutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address hnsutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
	cmd := hnsjson.NewDumpPrivKeyCmd(addr)
	return c.SendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address hnsutil.Address) (*hnsutil.WIF, error) {
...
func (c *Client) ImportAddressAsync(address string) FutureImportAddressResult {
	cmd := hnsjson.NewImportAddressCmd(address, "", nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ImportAddressRescanAsync(address string, account string, rescan bool) FutureImportAddressResult {
	cmd := hnsjson.NewImportAddressCmd(address, account, &rescan)
	return c.SendCmd(cmd)
}
...
func (r FutureImportMultiResult) Receive() (hnsjson.ImportMultiResults, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var importMultiResults hnsjson.ImportMultiResults
...
func (c *Client) ImportMultiAsync(requests []hnsjson.ImportMultiRequest, options *hnsjson.ImportMultiOptions) FutureImportMultiResult {
	cmd := hnsjson.NewImportMultiCmd(requests, options)
	return c.SendCmd(cmd)
}
...
//
// See hnsjson.ImportMultiRequest for details on the requests parameter.
func (c *Client) ImportMulti(requests []hnsjson.ImportMultiRequest, options *hnsjson.ImportMultiOptions) (hnsjson.ImportMultiResults, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *hnsutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := hnsjson.NewImportPrivKeyCmd(wif, nil, nil)
	return c.SendCmd(cmd)
}

// ImportPrivKey imports the passed private key which must be the wallet import
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *hnsutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *hnsutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := hnsjson.NewImportPrivKeyCmd(wif, &label, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *hnsutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *hnsutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := hnsjson.NewImportPrivKeyCmd(wif, &label, &rescan)
	return c.SendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *hnsutil.WIF, label string, rescan bool) error {
...
func (c *Client) ImportPubKeyAsync(pubKey string) FutureImportPubKeyResult {
	cmd := hnsjson.NewImportPubKeyCmd(pubKey, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ImportPubKeyRescanAsync(pubKey string, rescan bool) FutureImportPubKeyResult {
	cmd := hnsjson.NewImportPubKeyCmd(pubKey, &rescan)
	return c.SendCmd(cmd)
}
...
// NOTE: While getinfo is implemented here (in wallet.go), a handshake-node chain server
...
func (r FutureGetInfoResult) Receive() (*hnsjson.InfoWalletResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes hnsjson.InfoWalletResult
...
func (c *Client) GetInfo() (*hnsjson.InfoWalletResult, error) {
...
func (r FutureWalletCreateFundedPsbtResult) Receive() (*hnsjson.WalletCreateFundedPsbtResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var psbtRes hnsjson.WalletCreateFundedPsbtResult
...
func (c *Client) WalletCreateFundedPsbtAsync(
	inputs []hnsjson.PsbtInput, outputs []hnsjson.PsbtOutput, locktime *uint32,
	options *hnsjson.WalletCreateFundedPsbtOpts, bip32Derivs *bool,
) FutureWalletCreateFundedPsbtResult {
	cmd := hnsjson.NewWalletCreateFundedPsbtCmd(inputs, outputs, locktime, options, bip32Derivs)
	return c.SendCmd(cmd)
}
...
func (c *Client) WalletCreateFundedPsbt(
	inputs []hnsjson.PsbtInput, outputs []hnsjson.PsbtOutput, locktime *uint32,
	options *hnsjson.WalletCreateFundedPsbtOpts, bip32Derivs *bool,
) (*hnsjson.WalletCreateFundedPsbtResult, error) {
...
func (r FutureWalletProcessPsbtResult) Receive() (*hnsjson.WalletProcessPsbtResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var psbtRes hnsjson.WalletProcessPsbtResult
	err = json.Unmarshal(res, &psbtRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) WalletProcessPsbtAsync(
	...
	cmd := hnsjson.NewWalletProcessPsbtCmd(psbt, sign, hnsjson.String(sighashType.String()), bip32Derivs)
	return c.SendCmd(cmd)
}
...
func (c *Client) WalletProcessPsbt(
	psbt string, sign *bool, sighashType SigHashType, bip32Derivs *bool,
) (*hnsjson.WalletProcessPsbtResult, error) {
...
func (r FutureGetWalletInfoResult) Receive() (*hnsjson.GetWalletInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var getWalletInfoResult hnsjson.GetWalletInfoResult
...
func (c *Client) GetWalletInfoAsync() FutureGetWalletInfoResult {
	cmd := hnsjson.NewGetWalletInfoCmd()
	return c.SendCmd(cmd)
}

// GetWalletInfo returns various wallet state info.
func (c *Client) GetWalletInfo() (*hnsjson.GetWalletInfoResult, error) {
...
func (c *Client) BackupWalletAsync(destination string) FutureBackupWalletResult {
	return c.SendCmd(hnsjson.NewBackupWalletCmd(destination))
}
...
// Receive waits for the Response promised by the future
func (r FutureDumpWalletResult) Receive() (*hnsjson.DumpWalletResult, error) {
	bytes, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var res hnsjson.DumpWalletResult
...
func (c *Client) DumpWalletAsync(destination string) FutureDumpWalletResult {
	return c.SendCmd(hnsjson.NewDumpWalletCmd(destination))
}

// DumpWallet dumps all wallet keys in a human-readable format to a server-side file.
func (c *Client) DumpWallet(destination string) (*hnsjson.DumpWalletResult, error) {
...
func (c *Client) ImportWalletAsync(filename string) FutureImportWalletResult {
	return c.SendCmd(hnsjson.NewImportWalletCmd(filename))
}
...
func (c *Client) UnloadWalletAsync(walletName *string) FutureUnloadWalletResult {
	return c.SendCmd(hnsjson.NewUnloadWalletCmd(walletName))
}
...
// Receive waits for the Response promised by the future
func (r FutureLoadWalletResult) Receive() (*hnsjson.LoadWalletResult, error) {
	bytes, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	var result hnsjson.LoadWalletResult
...
func (c *Client) LoadWalletAsync(walletName string) FutureLoadWalletResult {
	return c.SendCmd(hnsjson.NewLoadWalletCmd(walletName))
}

// LoadWallet loads a wallet from a wallet file or directory.
func (c *Client) LoadWallet(walletName string) (*hnsjson.LoadWalletResult, error) {
