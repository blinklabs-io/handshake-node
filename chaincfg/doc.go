...
//	        flag.Parse()
//
//	        // Modify active network parameters if operating on regtest.
//	        if *regtest {
...
//	        addr, err := hnsutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
//	        if err != nil {
//	                log.Fatal(err)
//	        }
//	        fmt.Println(addr)
//	}
//
// If an application does not use one of the standard Handshake networks,
