...
var helpDescsEnUS = map[string]string{
	...
	"getpeerinforesult-v2_connection":  "Whether or not the peer negotiated Handshake Brontide encryption",
	...
	// NotifyNamesCmd help.
	"notifynames--synopsis":  "Send a nameupdated notification when a mempool transaction or newly-attached block contains a matching Handshake name covenant.",
	"notifynames-names":      "Optional names to receive notifications about. When omitted along with namehashes, all name covenant updates are sent.",
	"notifynames-namehashes": "Optional name hashes to receive notifications about. When omitted along with names, all name covenant updates are sent.",

	// StopNotifyNamesCmd help.
	"stopnotifynames--synopsis": "Cancel registered Handshake name covenant update notifications.",
	...
	// NameUpdatedNtfn help.
	"nameupdatedntfn-name":         "The raw Handshake name when available",
	"nameupdatedntfn-namehash":     "The consensus name hash",
	"nameupdatedntfn-covenant":     "The covenant type name",
	"nameupdatedntfn-covenanttype": "The numeric covenant type",
	"nameupdatedntfn-txid":         "The transaction hash",
	"nameupdatedntfn-vout":         "The transaction output index containing the covenant",
	"nameupdatedntfn-block":        "The block details when the covenant is confirmed",
...
var rpcResultTypes = map[string][]any{
	"addnode":                nil,
	"createbid":              {(*string)(nil)},
	"createfinalize":         {(*string)(nil)},
	"createopen":             {(*string)(nil)},
	"createrawtransaction":   {(*string)(nil)},
	"createregister":         {(*string)(nil)},
	"createredeem":           {(*string)(nil)},
	"createrenew":            {(*string)(nil)},
	"createreveal":           {(*string)(nil)},
	"createrevoke":           {(*string)(nil)},
	"createtransfer":         {(*string)(nil)},
	...
	"getnamebyhash":          {(*hnsjson.GetNameInfoResult)(nil)},
	"getnameinfo":            {(*hnsjson.GetNameInfoResult)(nil)},
	"getnameproof":           {(*hnsjson.GetNameProofResult)(nil)},
	"getnameresource":        {(*hnsjson.GetNameResourceResult)(nil)},
	...
	"verifynameproof":        {(*hnsjson.VerifyNameProofResult)(nil)},
